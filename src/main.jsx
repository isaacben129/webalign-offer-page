    ...
    <main className="text-[#1A1A1A]">
      <section className="bg-[#EFEFEF] text-[#1A1A1A] min-h-[100svh] pb-[clamp(48px,8vh,96px)] pt-0">
        ...
        <div className="px-[clamp(24px,6vw,80px)] pt-[clamp(72px,12vh,140px)]">
          <h1 className="headline-font w-full text-[#1A1A1A] text-[clamp(44px,10vw,96px)] leading-[0.9] tracking-[-0.03em] md:w-[80%] lg:w-[60%]">YOUR IDEA IS WORTHLESS UNTIL IT'S LIVE.</h1>

          <div className="mt-[clamp(24px,4vh,40px)] flex w-full flex-col gap-3 md:w-[80%] lg:w-[60%]">
